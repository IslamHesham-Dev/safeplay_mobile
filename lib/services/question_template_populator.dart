  ...
  List<Map<String, dynamic>> _createJuniorMathQuestions() {
    return [
      ...
      // Question 3: Addition
      {
        ...
        'gameTypes': ['koalaCounterAdventure', 'numberGridRace'],
        'recommendedGameType': 'koalaCounterAdventure',
        'isActive': true,
        'createdAt': FieldValue.serverTimestamp(),
        'updatedAt': FieldValue.serverTimestamp(),
        'metadata': {
      ...
      // Question 9: Measurement - Length
      {
        ...
        'difficultyLevel': 'medium',
        'estimatedTimeSeconds': 35,
        'gameTypes': ['ordinalDragOrder', 'patternBuilder'],
        'recommendedGameType': 'ordinalDragOrder',
        'isActive': true,
        'createdAt': FieldValue.serverTimestamp(),
        'updatedAt': FieldValue.serverTimestamp(),
        'metadata': {
      ...
      // Question 12: Comparing Numbers
      {
        ...
        'difficultyLevel': 'easy',
        'estimatedTimeSeconds': 30,
        'gameTypes': ['numberGridRace', 'ordinalDragOrder'],
        'recommendedGameType': 'numberGridRace',
        'isActive': true,
        'createdAt': FieldValue.serverTimestamp(),
        'updatedAt': FieldValue.serverTimestamp(),
  ...
  List<Map<String, dynamic>> _createJuniorEnglishQuestions() {
    return [
      // Question 1: Spelling/Suffixes
      {
        ...
        'type': 'multipleChoice',
        'prompt':
            'To change the word LIVE into a word that describes something happening now (living), what is the spelling rule you usually follow?',
        'options': [
          'Add -ing to the end',
          'Remove the \'e\' and add -ing',
          'Double the \'v\' and add -ing',
          'Add -ing and a new \'e\''
        ],
        'correctAnswer': 'Remove the \'e\' and add -ing',
        'explanation':
            'When adding -ing to words ending in \'e\', you drop the \'e\' and add -ing. So "live" becomes "living".',
        'hint':
            'Think about words ending in "e" - what happens to that letter?',
        'points': 20,
      ...
      // Question 3: Vocabulary/Plurals
      {
        ...
        'type': 'multipleChoice',
        'prompt':
            'When making a plural, words ending in \'f\' or \'fe\' often change the \'f\' to what?',
        'options': ['p', 'v', 'ph', 'ff'],
        'correctAnswer': 'v',
        'explanation':
            'Words ending in \'f\' or \'fe\' often change to \'v\' before adding -es. For example: leaf → leaves, knife → knives.',
        'hint': 'Think of words like "leaf" - what is the plural?',
        'points': 20,
        ...
        'difficultyLevel': 'medium',
        'estimatedTimeSeconds': 30,
        'gameTypes': ['wordBuilder', 'patternBuilder'],
        'recommendedGameType': 'wordBuilder',
        'isActive': true,
        'createdAt': FieldValue.serverTimestamp(),
        'updatedAt': FieldValue.serverTimestamp(),
      ...
      // Question 4: Adverbs (How)
      {
        ...
        'type': 'multipleChoice',
        'prompt': 'Which of these words tells you HOW the student answered?',
        'options': ['today', 'downstairs', 'politely', 'always'],
        'correctAnswer': 'politely',
        'explanation':
            '\'Politely\' is an adverb that describes HOW the student answered. It tells the manner in which the action was done.',
        'hint': 'Which word describes the WAY something is done?',
        'points': 20,
        ...
        'metadata': {
          'citation': 'PYP 1/2',
          'learningObjective': 'Identify adverbs that describe how',
      ...
      // Question 6: Comprehension (Fact)
      {
        ...
        'difficultyLevel': 'medium',
        'estimatedTimeSeconds': 40,
        'gameTypes': ['storySequencer', 'memoryMatch'],
      ...
      // Question 7: Spelling (-ed endings)
      {
        ...
        'type': 'multipleChoice',
        'prompt':
            'If a word ends in a single consonant with a short vowel before it (like DROP), what must you do before adding -ed?',
        'options': [
          'Nothing, just add -ed',
          'Remove the vowel',
        ...
        'correctAnswer': 'Double the final consonant',
        'explanation':
            'When a word ends in a single consonant with a short vowel before it, you double the final consonant before adding -ed. So "drop" becomes "dropped".',
        'hint': 'Think about words like "stop" - what is the past tense?',
        'points': 25,
