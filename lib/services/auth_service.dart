...
class AuthService {
  ...
  Future<void> sendCredentialsEmail({
    ...
    try {
      ...
      final callable = functions.httpsCallable('sendChildCredentialsEmail');

      await callable.call({
        'to': to,
        'subject': subject,
        'html': '', // Will be generated by the function
        'childName': childName,
        'authType': authType,
        'credentials': credentials,
      });
    } catch (e) {
      print('[AuthService]: Error sending credentials email: $e');
