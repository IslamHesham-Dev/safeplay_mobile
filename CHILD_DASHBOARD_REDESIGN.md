...
- **Age Group Badges**: Colorful badges with emojis (🌟 Junior Explorer / 🚀 Bright Mind)
...
- **Number Grid Race**: Orange gradient (brandOrange500 → brandOrange600)
- **Koala Counter Adventure**: Pink to Purple (juniorPink → juniorPurple)
- **Fraction Navigator**: Teal gradient (brightTeal → brandTeal500)
- **Inverse Operation Chain**: Indigo to Deep Purple (brightIndigo → brightDeepPurple)
- **Ordinal Drag Order**: Cyan to Teal (juniorCyan → brandTeal500)
- **Pattern Builder**: Amber to Orange (brightAmber → brandOrange500)
- **Data Visualization**: Lime to Teal (juniorLime → brightTeal)
- **Cartesian Grid**: Deep Purple to Purple (brightDeepPurple → juniorPurple)
